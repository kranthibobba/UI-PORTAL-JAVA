...
/*Scenario covers End-End Flow:
 * Navigate to Users page,
 * Check for existence & click on New User button, 
 * Navigate to Signup page 
 * Input invalid parameters to capture the error values
 * Pass valid parameters and create customer account
*/
